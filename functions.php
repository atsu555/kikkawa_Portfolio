 ...
 * init theme support
 */
function kikkawaPortfolio_theme_support() {
	...
	register_nav_menus( array (
		'main-menu' => __( 'mainmenu', 'kikkawaPortfolio' )
	) );
}
add_action( 'after_setup_theme', 'kikkawaPortfolio_theme_support' );
